        ...
        child: Form(
          ...
          child: Column(
            children: [
              ...
              const SizedBox(height: 15),
              Row(children: [
                Expanded(child: DropdownButtonFormField<String>(initialValue: gender, decoration: inputDeco('Ling', Icons.wc), items: ['Male','Female'].map((e) => DropdownMenuItem(value: e, child: Text(e))).toList(), onChanged: (val) => setState(() => gender = val))),
                const SizedBox(width: 10),
                Expanded(child: DropdownButtonFormField<String>(initialValue: maritalStatus, decoration: inputDeco('Vaivahik Sthiti', Icons.favorite), items: ['Unmarried','Divorced','Widow'].map((e) => DropdownMenuItem(value: e, child: Text(e))).toList(), onChanged: (val) => setState(() => maritalStatus = val))),
              ]),
              const SizedBox(height: 15),
              DropdownButtonFormField<String>(initialValue: selectedReligion, decoration: inputDeco('Dharm / Religion', Icons.temple_hindu), items: religionList.map((rel) => DropdownMenuItem(value: rel, child: Text(rel))).toList(), onChanged: (val) => setState(() => selectedReligion = val), validator: (v) => v == null? 'Dharm select karo' : null),
              const SizedBox(height: 15),
              ...
              const SizedBox(height: 15),
              DropdownButtonFormField<String>(initialValue: selectedState, decoration: inputDeco('Rajya / State', Icons.location_on), items: stateList.map((state) => DropdownMenuItem(value: state, child: Text(state))).toList(), onChanged: (val) => setState(() => selectedState = val), validator: (v) => v == null? 'Rajya select karo' : null),
              const SizedBox(height: 15),
